...
export default function MovieBoxDetailPage() {
  ...
  const { items: fetchedItems, isLoading: isItemsLoading, isFetchingMore, loadMore } = useBoxItems(id as string);
        ...
        {showInitialLoading ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
              <Text style={{ color: 'rgba(255,255,255,0.5)' }}>No videos added yet.</Text>
            </View>
          </View>
        ) : (
          <FlatList
