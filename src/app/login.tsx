      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.content}>
          ...
          <View style={styles.inputContainer}>
            <TextInput style={styles.input} placeholder="Username, email or phone" placeholderTextColor="rgba(255, 255, 255, 0.3)" value={identifier} onChangeText={setIdentifier} autoCapitalize="none" />
          </View>
          ...
          {/* Password Input */}
          <View style={styles.inputContainer}>
            <TextInput style={styles.input} placeholder="Password" placeholderTextColor="rgba(255, 255, 255, 0.3)" secureTextEntry={obscureText} value={password} onChangeText={setPassword} />
          ...
          {/* Login Button */}
          <TouchableOpacity activeOpacity={1} style={[styles.loginButton, !identifier || !password ? styles.loginButtonDisabled : null]} onPress={handleLogin} disabled={!identifier || !password || isLoading}>
