...
export default function LocalizationSettingsPage() {
  ...
  return <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <FlatList data={LANGUAGES} keyExtractor={item => item.code} renderItem={({
        item
      }) => {
        const isSelected = item.code === lang;
        return <TouchableOpacity activeOpacity={1} style={styles.languageItem} onPress={() => handleLanguageSelect(item.code)}>
                <View>
