...
export default function HelpPage() {
  ...
  const HELP_ITEMS = [
    { id: 'report', title: t('report_problem'), icon: AlertTriangle },
    { id: 'center', title: t('help_center'), icon: HelpCircle },
    { id: 'privacy', title: t('privacy_security_help'), icon: ShieldCheck },
    { id: 'support', title: t('support_requests'), icon: MessageSquare },
  ];
