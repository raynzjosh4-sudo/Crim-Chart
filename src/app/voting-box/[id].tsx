...
export default function VotingBoxDetailPage() {
  ...
  const renderHeader = () => <View style={styles.headerContainer}>
      ...
      <View style={styles.widgetWrapper}>
        <RecentContributorsWidget contributors={uniqueMembers} selectedMemberId={selectedMemberId} onSelectMember={setSelectedMemberId} />
      </View>
    </View>;
  ...
  return <CreatorActionWrapper ownerId={(fetchedBox as any)?.raw?.owner_id} onAddPress={handleAddPress}>
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          alignItems: 'center'
            ...
            </View> : <FlatList data={sortedItems} keyExtractor={item => item.id} ListHeaderComponent={renderHeader} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false} numColumns={2} columnWrapperStyle={styles.columnWrapper} renderItem={({
          item,
          index
