...
const styles = StyleSheet.create({
  ...
  backArrow: { color: '#FFF', fontSize: 30, fontWeight: '300' },
  appBarTitle: { color: '#FFF', fontSize: 18, fontWeight: '900' },
  centered: {
    flex: 1,
    alignItems: 'center',
  ...
  errorText: { color: 'rgba(255,255,255,0.5)', fontSize: 16, marginBottom: 12 },
  retryText: { color: '#FACD11', fontWeight: '800', fontSize: 15 },
  separator: { height: 1, backgroundColor: 'rgba(255,255,255,0.05)', marginLeft: 92 },
});
