...
export default function CrownTitlePage() {
  ...
  const handleNext = async () => {
    ...
    await updateProfile({ crown_title: crownTitle });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={isDesktop ? styles.desktopWrapper : styles.flexOne}>
        <View style={[styles.content, isDesktop && styles.desktopModal]}>
          ...
          <TouchableOpacity activeOpacity={1}
            style={[styles.nextButton, (!crownTitle || crownTitle.length < 1) && styles.nextButtonDisabled]}
            onPress={crownTitle ? handleNext : handleSkip}
            disabled={isLoading}
          >
