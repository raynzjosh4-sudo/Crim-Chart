...
export default function OtpPage() {
  ...
  const { verifyOtp, resendOtp, pendingSignUp } = useAuthStore();
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={isDesktop ? styles.desktopWrapper : styles.flexOne}>
        <View style={[styles.content, isDesktop && styles.desktopModal]}>
          <Text style={[styles.title, isDesktop && { textAlign: 'center', marginBottom: 12, fontSize: 28 }]}>Verify your email</Text>
        ...
        {resendStatus && (
          <Text style={{ color: colors.primary, fontSize: 13, marginTop: 8, marginLeft: 4 }}>
            {resendStatus}
          </Text>
        )}
        ...
        <TouchableOpacity activeOpacity={1}
          style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', marginTop: 8 }}
        ...
        <TouchableOpacity activeOpacity={1}
          style={[styles.nextButton, !isCodeValid && styles.nextButtonDisabled]}
          onPress={handleNext}
