...
const getAvatarColor = (initial: string) => {
  const colors = ['#F44336', '#E91E63', '#9C27B0', '#673AB7', '#3F51B5', '#2196F3', '#03A9F4', '#00BCD4', '#009688', '#4CAF50', '#8BC34A', '#CDDC39', '#CDDC39', '#6E7BFF', '#FF5722'];
  return colors[initial.charCodeAt(0) % colors.length] || colors[0];
};
export const MadeInChannel: React.FC<MadeInChannelProps> = ({
  channel,
  isSubChannel,
  index
}) => {
  ...
  return <TouchableOpacity activeOpacity={1} style={styles.container} onPress={() => navigation.navigate('ChannelPage', {
    channelId: channel.id
      ...
      <View style={styles.avatarContainer}>
        ...
        uri: imageUrl
      }} style={styles.avatar} /> : <View style={[styles.avatar, {
