  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topRow}>
        {topThree.map(g => (
          <View key={g.giftId} style={styles.giftItem}>
            {g.giftImageUrl ? (
              <Image source={{ uri: g.giftImageUrl }} style={styles.giftIcon} />
            ) : (
...
const styles = StyleSheet.create({
  ...
  giftIcon: { width: 48, height: 48, borderRadius: 10, backgroundColor: '#2A2A2A' },
  giftEmoji: { fontSize: 36 },
  giftCount: { color: 'rgba(255,255,255,0.6)', fontSize: 11, marginTop: 4 },
  seeAllBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    marginTop: 12,
  ...
  seeAllText: { color: '#FACD11', fontWeight: '700', fontSize: 13 },
});
