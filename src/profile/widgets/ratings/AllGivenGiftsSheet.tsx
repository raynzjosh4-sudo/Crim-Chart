  ...
  return <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View style={styles.backdrop}>
        <View style={styles.sheet}>
          ...
          <FlatList data={aggregations} keyExtractor={item => item.giftId} renderItem={({
          item
        }) => <View style={styles.row}>
                {item.giftImageUrl ? <Image source={{
            uri: item.giftImageUrl
          }} style={styles.icon} /> : <Text style={styles.iconPlaceholder}>🎁</Text>}
