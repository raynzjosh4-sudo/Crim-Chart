...
// We reuse the same prop structure as MusicTagWidget for consistency
interface ImageTagWidgetProps {
  key?: string | number;
  post: {
    id: string;
    author_id: string;
...
export const ImageTagWidget: React.FC<ImageTagWidgetProps> = ({ post }) => {
