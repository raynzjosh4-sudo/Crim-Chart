...
export const ChatListTile: React.FC<ChatListTileProps> = ({ chat, onTap, showTime = true, compact = false, showRightCount = false, hideStar = false }) => {
    ...
    >
      <View style={styles.avatarContainer}>
        <View style={styles.avatarWrapper}>
          <MemberImage
            size={56}
            imageUrl={chat.senderAvatarUrl}
            showStatusRing={true}
            ringColor={isUnread ? colors.primary : undefined}
          />
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <View style={styles.rightContainer}>
            ...
            {(showRightCount || (showTime && isUnread)) ? (
