...
export function LoginModalWidget({
  visible,
  onClose,
  initialUsername = '',
  initialPassword = ''
}: LoginModalWidgetProps) {
  const styles = useStyles(colors => ({
    ...
    modalContainer: {
      ...
      ...(isWeb ? {
        boxShadow: '0 0 15px rgba(255,255,255,0.05)' as any
      } : {})
    },
    header: {
      flexDirection: 'row',
    ...
    inputLabel: {
      ...
      fontSize: 15,
      ...(isWeb ? {
        transition: '0.2s all ease-in-out' as any
      } : {})
    },
    inputLabelActive: {
      top: 6,
  ...
  return <Modal visible={visible} transparent animationType="fade" onRequestClose={handleBack}>
        ...
        backgroundColor: colors.background
          ...
          <View style={styles.content}>
            {view === 'login' ? <>
              ...
              borderColor: usernameFocused ? colors.primary : colors.textSecondary
              ...
              }, (usernameFocused || username.length > 0) && styles.inputLabelActive, usernameFocused && {
                ...
                color: colors.text
              }]} value={username} onChangeText={setUsername} onFocus={() => setUsernameFocused(true)} onBlur={() => setUsernameFocused(false)} autoCapitalize="none" />
                </View>
              ...
              borderColor: passwordFocused ? colors.primary : colors.textSecondary
                  ...
                  <Text style={[styles.inputLabel, {
                color: colors.textSecondary
              }, (passwordFocused || password.length > 0) && styles.inputLabelActive, passwordFocused && {
                color: colors.primary
              }]}>
                    Password
                  </Text>
                  ...
                  flex: 1,
                  color: colors.text
                }]} value={password} onChangeText={setPassword} onFocus={() => setPasswordFocused(true)} onBlur={() => setPasswordFocused(false)} secureTextEntry={!showPassword} />
              ...
              borderColor: forgotFocused ? colors.primary : colors.textSecondary
                  ...
                  <Text style={[styles.inputLabel, {
                color: colors.textSecondary
              }, (forgotFocused || forgotInput.length > 0) && styles.inputLabelActive, forgotFocused && {
                color: colors.primary
              }]}>
                    Email or username
                  </Text>
                  <TextInput style={[styles.input, {
                color: colors.text
              }]} value={forgotInput} onChangeText={setForgotInput} onFocus={() => setForgotFocused(true)} onBlur={() => setForgotFocused(false)} autoCapitalize="none" />
                </View>
              ...
              backgroundColor: colors.text
            }, !isForgotContinueEnabled && {
              backgroundColor: 'rgba(255,255,255,0.4)'
            }, pressed && isForgotContinueEnabled && {
              opacity: 0.8
