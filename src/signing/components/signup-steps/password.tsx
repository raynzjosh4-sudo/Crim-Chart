      ...
      <View style={styles.flexOne}>
        ...
        <View style={styles.inputContainer}>
          <TextInput style={[styles.input, Platform.OS === 'web' ? {
            outlineStyle: 'none'
          } as any : {}]} placeholder="Enter password" placeholderTextColor="rgba(255, 255, 255, 0.2)" secureTextEntry={obscureText} autoCapitalize="none" value={password} onChangeText={text => {
        ...
        <TouchableOpacity activeOpacity={1} style={styles.autoGenerate} onPress={generateStrongPassword}>
        ...
        <TouchableOpacity activeOpacity={1} style={[styles.nextButton, !isPasswordValid && styles.nextButtonDisabled]} onPress={handleNext} disabled={!isPasswordValid || isLoading}>
