...
export default function UsernamePage({ onNext, onBack, onClose }: StepProps) {
      ...
      <View style={styles.flexOne}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput style={[styles.input, Platform.OS === 'web' ? {
            outlineStyle: 'none'
          } as any : {}]} placeholder="username" placeholderTextColor="rgba(255, 255, 255, 0.2)" autoCapitalize="none" autoCorrect={false} value={username} onChangeText={text => setUsername(text.toLowerCase())} autoFocus />
        </View>
        ...
        <TouchableOpacity activeOpacity={1} style={[styles.nextButton, username.length < 3 && styles.nextButtonDisabled]} onPress={handleNext} disabled={username.length < 3 || isLoading}>
