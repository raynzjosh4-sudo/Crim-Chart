...
const styles = StyleSheet.create({
  ...
  cameraView: { flex: 1, width: '100%', justifyContent: 'flex-end' },
  editorContainer: { flex: 1, width: '100%', justifyContent: 'center', alignItems: 'center' },
  controlsContainer: { width: '100%', alignItems: 'center', marginBottom: 40 },
  recordButton: { width: 80, height: 80, borderRadius: 40, borderWidth: 5, borderColor: '#fff', backgroundColor: 'transparent' },
  recordingActive: { backgroundColor: '#ff0000', borderColor: '#ff0000' },
  text: { color: 'white', fontSize: 20, fontWeight: 'bold' },
  subtext: { color: 'gray', fontSize: 12, marginTop: 10, textAlign: 'center' },
  actionButton: { marginTop: 20, padding: 15, backgroundColor: '#ff0050', borderRadius: 8 },
