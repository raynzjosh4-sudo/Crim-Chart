...
interface CommentInputFieldProps {
  controller: { value: string; onChange: (v: string) => void };
  ...
  return (
    <View
      style={[
        ...
        isTikTokStyle && { paddingTop: 10, paddingBottom: 10 },
        style,
      ]}
    >
      <View style={styles.row}>
        ...
        {showTextField ? (
          ...
          >
            {onTap ? (
              ...
              >
                <Text style={{ color: 'rgba(255,255,255,0.38)', fontSize: 15 }}>
              ...
              <TextInput
                ...
                placeholder={isTikTokStyle ? 'Add comment...' : tr('message') || 'Message'}
        ...
        {isTikTokStyle ? (
          ...
          >
            <Send
              color={showSend ? colors.primary : 'rgba(255,255,255,0.24)'}
              size={28}
            />
          </TouchableOpacity>
        ) : (
          ...
          >
            <AnimatedSendButton
              ...
              size={22}
              color={
                showSend ? 'white' : 'rgba(255,255,255,0.5)'
              }
              onTap={showSend ? () => onSend(controller.value) : () => { }}
