...
export const LyricsSheet: React.FC<LyricsSheetProps> = ({ visible, onClose, lyrics }) => {
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent={true} onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={[styles.sheet, isDesktop && styles.sheetDesktop, { paddingBottom: Math.max(insets.bottom + 20, 20) }]}>
