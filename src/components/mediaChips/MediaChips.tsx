...
export const MediaChips: React.FC<MediaChipsProps> = ({
  activeTabIndex,
  selectedAlbum,
  onAlbumSelected
}) => {
  ...
  return <View style={styles.container}>
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        return <TouchableOpacity activeOpacity={1} key={album.id} style={[styles.chip, isSelected ? styles.chipSelected : styles.chipUnselected]} onPress={() => onAlbumSelected(album.id === 'all' ? null : album.id)} activeOpacity={0.7}>
