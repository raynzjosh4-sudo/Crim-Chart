...
export const CustomCamera = () => {
  ...
  return <View style={styles.container}>
      <CameraView ref={cameraRef} style={StyleSheet.absoluteFill} facing={facing} mode={mode} enableTorch={flash === 'on'}>
        ...
        paddingTop: Math.max(insets.top, 16)
          ...
          {isRecording && <View style={styles.recordingTimer}>
        ...
        paddingBottom: Math.max(insets.bottom, 32)
          ...
          <TouchableOpacity activeOpacity={1} style={[styles.captureRing, isRecording && {
          borderColor: '#E50914'
        }]} onPress={takePicture} onLongPress={startRecording} onPressOut={stopRecording} delayLongPress={200} disabled={isCapturing}>
            <View style={[styles.captureButton, isRecording && {
            backgroundColor: '#E50914',
            borderRadius: 8,
            width: 32,
            height: 32
