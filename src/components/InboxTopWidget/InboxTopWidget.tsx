...
export const InboxTopWidget: React.FC<InboxTopWidgetProps> = ({
  ...
  const ringColor = (participantStats?.showStatusCircle !== false) 
    ? getStatusColor(totalInboxes) 
    : 'transparent';
  ...
  return (
    <View style={styles.container}>
      ...
      {participantStats?.showAgePref !== false && participantStats?.preferredAgeRanges && participantStats.preferredAgeRanges.length > 0 && (
      ...
      {participantStats?.showCountryPref !== false && participantStats?.preferredCountries && participantStats.preferredCountries.length > 0 && (
        <Text style={styles.subStatus}>
