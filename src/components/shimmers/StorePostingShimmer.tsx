...
export const StorePostingItemShimmer = () => {
  return <View style={styles.itemContainer}>
      ...
      <View style={styles.header}>
        ...
        flex: 1
          ...
          <View style={styles.headerText}>
            ...
            <AnimatedShimmerBlock width={60} height={12} borderRadius={4} style={{
            marginTop: 4
          }} />
          </View>
        </View>
      ...
      <View style={styles.infoContainer}>
        ...
        {/* Description */}
        <AnimatedShimmerBlock width={width * 0.8} height={14} borderRadius={4} style={{
        marginBottom: 4
      }} />
        <AnimatedShimmerBlock width={width * 0.6} height={14} borderRadius={4} style={{
        marginBottom: 16
      }} />
