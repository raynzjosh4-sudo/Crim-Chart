...
export const VideoScrubber = ({
  ...
  const styles = useStyles(colors => ({
    ...
    scrubberDot: {
      ...
      right: -6,
      bottom: 0,
      // Dot touches absolute bottom edge so it doesn't clip
      width: 12,
      height: 12,
      borderRadius: 6,
  ...
  return <View style={[styles.progressBarContainer, hideBottomInput ? {
    bottom: 0
  } : {
    bottom: 58
  }, isScrubbing && {
    height: 16
  }]} pointerEvents="auto" onStartShouldSetResponder={() => true} onMoveShouldSetResponder={() => true} onResponderGrant={onScrubGrant} onResponderMove={onScrubMove} onResponderRelease={onScrubRelease} onResponderTerminate={onScrubRelease}>
      ...
      marginTop: 6
        ...
        <View style={[styles.scrubberDot, !isScrubbing && {
        opacity: 0
      }]} />
      </View>
    </View>;
