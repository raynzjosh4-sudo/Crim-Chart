...
export const OverscrollStatusReveal: React.FC<OverscrollStatusRevealProps> = ({
  overscroll,
  user
}) => {
      ...
      scale
        ...
        <TouchableOpacity activeOpacity={0.8} onPress={handlePress}>
          <View style={styles.avatarWrapper}>
            <AppAvatar url={user.profileImageUrl} size={64} showStatusRing={true} showActiveDot={false} />
          </View>
        </TouchableOpacity>
