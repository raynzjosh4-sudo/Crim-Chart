...
export const BackCard: React.FC<BackCardProps> = ({
  ...
  return (
    <TouchableOpacity activeOpacity={0.9} onPress={() => { pulse(); onTap?.(); }}>
      <Animated.View
        style={[
          styles.container,
          { width, height, borderColor: `${color}CC`, transform: [{ scale: scaleAnim }], opacity }
        ]}
      >
        ...
        {model && (
          <View style={styles.gradientOverlay}>
            ...
            <View style={{ height: 2 }} />
            <Text style={[styles.kpText, { color: `${color}E6` }]}>
