...
BEGIN
  ...
  FROM (
    SELECT json_build_object(
      ...
      'dislikes_count', bi.dislikes_count,
      ...
      'post', json_build_object(
        ...
        'media_url', COALESCE(cp.audio_url, p.audio_url, cp.video_url, p.video_url), 
        'thumbnail_url', COALESCE(cp.thumbnail_urls, p.thumbnail_urls), 
