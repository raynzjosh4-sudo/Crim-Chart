...
export const ActiveChannelCircle: React.FC<ActiveChannelCircleProps> = ({
  ...
  return <TouchableOpacity activeOpacity={0.8} onPress={onTap} style={styles.container}>
      ...
      height: size
        ...
        {leaderAvatarUrl ? <ChannelAvatar imageUrl={imageUrl} leaderAvatarUrl={leaderAvatarUrl} size={size} isActive={hasUpdate} /> : <AppAvatar size={size} url={imageUrl} showStatusRing={hasUpdate} showActiveDot={hasUpdate} />}
      </View>
      <View style={{
      height: 8
    }} />
