  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        {currentMember?.title && (
          <Text style={styles.titleText}>{currentMember.title}</Text>
        )}

        {currentMember?.pointsDisplay && (
          <Text style={styles.pointsText}>{currentMember.pointsDisplay}</Text>
        )}

        {currentMember?.receivedGifts && currentMember.receivedGifts.length > 0 && (
