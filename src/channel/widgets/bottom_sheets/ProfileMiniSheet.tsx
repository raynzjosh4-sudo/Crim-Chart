...
const MOCK_MOMENTS = ['https://picsum.photos/400/600', 'https://picsum.photos/400/300', 'https://picsum.photos/400/301', 'https://picsum.photos/400/500', 'https://picsum.photos/400/501', 'https://picsum.photos/400/502'];
export const ProfileMiniSheet: React.FC<ProfileMiniSheetProps> = ({
  ...
  return <>
          ...
          <View style={styles.sheetContent}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.headerContainer}>
                <LinearGradient colors={['rgba(250, 205, 17, 0.4)', 'rgba(250, 205, 17, 0.1)', 'transparent']} style={styles.banner} />
                
                <View style={styles.avatarWrapper}>
                  <AppAvatar size={100} imageUrl={channel.imageUrl} hasStatus={false} style={styles.avatarBorder} />
                </View>
              </View>
              ...
              <View style={styles.momentsContainer}>
                ...
                <View style={styles.momentsGrid}>
                  {MOCK_MOMENTS.map((url, index) => <TouchableOpacity activeOpacity={1} key={index} style={[styles.momentItem, {
      ...
      {/* Moment Viewer Modal */}
      <Modal visible={selectedMomentIndex !== null} animationType="fade" transparent={true} onRequestClose={() => setSelectedMomentIndex(null)}>
        {selectedMomentIndex !== null && <StatusPage status={{
        author: {
      ...
      username={channel.title} userProfileImageUrl={channel.imageUrl || undefined} onClose={() => setSelectedMomentIndex(null)} onOptionsTap={() => {}} onProfileTap={() => {}} />}
      </Modal>
    </>;
};