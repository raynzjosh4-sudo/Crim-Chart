...
export const TagDiscoveryPage: React.FC = () => {
  ...
  return <View style={[styles.container, {
    backgroundColor: colors.background
      ...
      item
    }) => <TagListTile title={item.name} subtitle={item.description} imageUrl={item.avatarUrl} buttonText="Tag" postId={postId} sourceChannelId={sourceChannelId} targetChannelId={item.id} linkChain={linkChain} onTagSuccess={() => navigation.goBack()} />} contentContainerStyle={{
      paddingBottom: 40
