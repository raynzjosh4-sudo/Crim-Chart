...
export const TagCard: React.FC<TagCardProps> = ({
  ...
  return <TouchableOpacity style={[styles.container, {
    ...
    borderColor: dark ? 'rgba(255,255,255,0.06)' : colors.border
      ...
      backgroundColor: dark ? '#2A2A2A' : colors.background
        ...
        uri: imageUrl
      }} style={styles.image} /> : <View style={styles.imagePlaceholder}>
      ...
      {description && description.length > 0 && <Text style={[styles.description, {
      color: colors.text,
      opacity: 0.5
