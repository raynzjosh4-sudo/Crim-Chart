...
export const AudioStatusOverlay: React.FC<AudioStatusOverlayProps> = ({
  ...
  const lyricsStyle = useAnimatedStyle(() => ({
    transform: [{ translateY: lyricsScroll.value }],
  }));
    ...
    <View style={styles.container} pointerEvents="none">
      ...
      <View style={styles.centerContainer}>
        ...
        <Animated.View style={[styles.discContainer, discStyle]}>
          <Image
            source={thumbnail ? { uri: thumbnail } : require('@/../assets/images/icon.png')}
        ...
        <View style={styles.trackInfo}>
          <Music size={16} color="#FFB800" style={{ marginRight: 8 }} />
          <View>
