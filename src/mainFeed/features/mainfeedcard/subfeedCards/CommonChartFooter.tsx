...
export const CommonChartFooter: React.FC<CommonChartFooterProps> = ({
  ...
  return <View style={styles.container}>
      ...
      <TouchableOpacity onPress={onChartTap} style={[styles.button, {
      backgroundColor: isCharted ? themeColor : '#EEEEEE'
    }]} activeOpacity={0.8}>
        <Text style={[styles.buttonText, {
        color: isCharted ? theme.colors.text : theme.colors.background
      }]}>
          {chartPoints} Crowns
        </Text>
      </TouchableOpacity>
