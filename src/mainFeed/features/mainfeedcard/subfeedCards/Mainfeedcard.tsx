...
export const Mainfeedcard: React.FC<MainfeedcardProps> = ({
  data,
  isFeedView = true
}) => {
  ...
  return <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          ...
          {data.bio ? <Text style={styles.bio} numberOfLines={1}>👑 {data.bio}</Text> : null}
        </View>
      ...
      {/* Content */}
      <TouchableOpacity activeOpacity={isFeedView ? 0.9 : 1} onPress={() => {
      if (isFeedView) {
      ...
      {/* Footer */}
      <CrimChartFooter username={data.displayName} chartName={data.displayName} mutualCount={data.followersCount} isCharted={isActive} chartPoints={currentPoints} onChartTap={onChartTap} />
    </View>;
};