  ...
  const constructInitialState = (data: any, type?: string) => {
    ...
    const hydrated: MainFeedCardModel = {
      ...
      itemData: {
        ...
        metadata: metadata,
        tagsCount: Number(data.tags ?? data.tags_count ?? 0), 
        likesCount: Number(data.likes ?? data.likes_count ?? 0),
        downloadsCount: Number(data.downloads_count ?? data.downloadsCount ?? 0),
